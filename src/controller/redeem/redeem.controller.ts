  ...
  schema: {
    ...
    properties: {
      ...
      data: {
        type: 'object',
        properties: {
          id: { type: 'string', example: '49f2d9e6-1e16-45bc-a099-138c18217fa9' },
          redemption_date_and_time: { type: 'string', example: '2024-07-12T14:30:00.000Z' },
          list_of_medications: { type: 'string', example: '[{"medications_id":1},{"medications_id":1}]' },
          total_cost: { type: 'string', example: '100000' },
          bank_transfer_name: { type: 'string', example: 'John Doe' },
          bank_id: { type: 'string', example: '4e4e64df-5327-4bd4-8dc0-007df6ee3748' },
          user_id: { type: 'string', example: '1f4b0c0e-f297-45a7-8854-fccd7fddc5c4' },
          bank: {
            type: 'object',
            properties: {
              id: { type: 'string', example: '4e4e64df-5327-4bd4-8dc0-007df6ee3748' },
              ...
              bank_category_id: { type: 'string', example: '457beffd-b77c-4052-9ff7-06c74bde2815' }
            }
          },
          user: {
            type: 'object',
  ...
  async getRedeem(@Req() req: Request, @Res() res: Response) {
    try {
      ...
      if (getdata.status) {
        ...
        return res
          .status(400)
          .json(format_json(400, false, null, getdata.data, getdata.message, null));
      }
    } catch (error) {
      return res
        .status(400)
  ...
  async createRedeem(
    ...
    try {
      ...
      if (create.status) {
        ...
        return res
          .status(400)
          .json(format_json(400, false, null, create.data, create.message, null));
      }
    } catch (error) {
      return res
        .status(400)
  ...
  async UpdateRedeem(
    ...
    try {
      ...
      if (update.status) {
        ...
        return res
          .status(400)
          .json(format_json(400, false, null, update.data, update.message, null));
      }
    } catch (error) {
      return res
        .status(400)
